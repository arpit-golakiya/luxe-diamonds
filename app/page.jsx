            ...
            <section className="py-20 bg-background">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-muted-foreground">Explore our handpicked selection of premium
                            diamonds</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <Link href="/products/natural-diamonds" className="group">
                            <div className="relative h-96 bg-gray-200 rounded-lg overflow-hidden mb-4">
                                ...
                                />
                                <div
                                    className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex items-end p-6 group-hover:from-black/70 transition">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    Every diamond comes with certifications from leading gemological institutes,
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    We're committed to responsible practices, ensuring all diamonds are ethically
                                    sourced and
                                    conflict-free.
                                </p>
                            </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    Our master artisans create bespoke pieces tailored to your unique vision and
                                    preferences.
                                </p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    We stand behind our jewelry with lifetime maintenance, cleaning, and personalized
                                    customer service.
                                </p>
                            </div>
                        </div>
