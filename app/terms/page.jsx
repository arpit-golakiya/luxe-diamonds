    ...
    return (
        <div className="min-h-screen py-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-5xl font-serif font-bold mb-12">Terms & Conditions</h1>
                ...
                <div className="space-y-10 text-muted-foreground">
                    ...
                    <section>
                        ...
                        <p>
                            The materials on Ishanta Jewels' website are provided on an 'as is' basis. Ishanta Jewels makes no
